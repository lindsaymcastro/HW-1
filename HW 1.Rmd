...
In general, empirically-driven models are easier to understand because they are based on observation rather than theory. Sometimes mechanistic models rely
on formulas and theories that may not always accurately depict the data being modeled, especially for the real world.
